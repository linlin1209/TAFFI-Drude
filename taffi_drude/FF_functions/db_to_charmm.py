...
def main(argv):
    ...
    VDW_params = initialize_VDW(sorted(set(Data[args.coord_files[0]]['Atom_types'])),sigma_scale=args.sigma_scale,eps_scale=args.eps_scale,VDW_FF=Data[args.coord_files[0]]["VDW_params"],\
...
def Write_CHARMM(Filename,Atom_types,Elements,Geometry,Bonds,Bond_types,Bond_params,Angles,Angle_types,Angle_params,Dihedrals,Dihedral_types,Dihedral_params,\
    ...
    atom_polar = polar_atype(Atom_types,atomT,Elements,hybrid)
...
def polar_atype(Atom_types,atomT,Elements,hybrid):
