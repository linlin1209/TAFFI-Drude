...
import sys,argparse,os,fnmatch,random,time,matplotlib,re
import numpy as np
...
#    pair_hist_plot(Folder+'/figures',Fit_Pairs,Data,QC_type=QC_type)
    ...
    if QC_type == "DFT":
        ...
        write_params(Folder+'/DFT-AA',fit,eng_type='AA',write_charges=charges_opt) 
#        write_params(Folder+'/DFT-AA.db',fit,type='AA',write_charges=1) # Always writes parameters
        ...
        plot_fit_potentials(Folder+'/figures',fit,eng_type='DFT-AA',r_min=0.1,r_max=10.0)

        # Generate convergence plot
        plot_convergence(Folder+'/figures',Data,fit_vals,plot_num=5,eng_type='DFT-AA')
